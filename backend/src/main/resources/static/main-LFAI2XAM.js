    ...
    create(n, t, i, r) {
      ...
      try {
        ...
        let H = va(0, null, null, 1, 0, null, null, null, null, null, null),
          le = $r(null, H, null, x, null, null, g, b, a, null, R);
        na(le);
        let Y,
          fe,
          be = null;
          ...
          g = p.findIndex((b) => {
            if (Array.isArray(b)) {
              let [C, w] = b,
                ...
                R = s < w.hours || (s === w.hours && a < w.minutes);
              if (C.hours < w.hours) {
                if (x && R) return !0;
            ...
            yield this.ngZone.runOutsideAngular(() =>
              Ae(this, null, function* () {
                for (;;) {
                  ...
                  if (be) break;
                  if ((w.push(ce), (R += ce.length), t.reportProgress)) {
                    le =
                      t.responseType === 'text'
            ...
            () =>
              new ne((o) => {
                ...
                if (
                  ...
                  t.headers.forEach((x, R) => s.setRequestHeader(x, R.join(','))),
                ...
                let a = t.serializeBody(),
                  ...
                  p = () => {
                    ...
                    let x = s.statusText || 'OK',
                      R = new Ct(s.getAllResponseHeaders()),
                      H = Ry(s) || t.url;
                    return (
                      (d = new fo({ headers: R, status: s.status, statusText: x, url: H })),
                      d
                    );
                  },
                  h = () => {
                    let { headers: x, status: R, statusText: H, url: le } = p(),
                      Y = null;
                    (R !== Dy && (Y = typeof s.response > 'u' ? s.responseText : s.response),
                      R === 0 && (R = Y ? af : 0));
                    let fe = R >= 200 && R < 300;
                  ...
                  C = (x) => {
                    b || (o.next(p()), (b = !0));
                    let R = { type: Ot.DownloadProgress, loaded: x.loaded };
                    (x.lengthComputable && (R.total = x.total),
                      t.responseType === 'text' &&
                        s.responseText &&
                        (R.partialText = s.responseText),
                      o.next(R));
                  },
                  w = (x) => {
                    let R = { type: Ot.UploadProgress, loaded: x.loaded };
                    (x.lengthComputable && (R.total = x.total), o.next(R));
                  };
                return (
...
var yo = class {
  ...
  Ux = ee(Z({}, vv), { '[class.ng-submitted]': 'isSubmitted' }),
  Ff = (() => {
    class e extends vo {
      constructor(t) {
        super(t);
...
function Jv(e, n) {
  ...
  if (e & 2) {
    let t = m(3);
    (f(2), S('ngModel', t.profile.databaseName));
  }
}
function Xv(e, n) {
  if (e & 1) {
  ...
  if (e & 2) {
    let t = m(3);
    (f(2), S('ngModel', t.profile.serviceName));
  }
}
function eC(e, n) {
  if (e & 1) {
...
function nC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'div', 28)(1, 'form', 29),
      ...
      c()(),
      I(37, Jv, 3, 1, 'label', 13)(38, Xv, 3, 1, 'label', 13),
      l(39, 'label'),
      u(40, 'Username'),
      l(41, 'input', 39),
      M('ngModelChange', function (r) {
      ...
      u(44, ' Enable TLS'),
      c(),
      I(45, eC, 3, 1, 'label', 13)(46, tC, 3, 1, 'label', 13),
      c(),
      l(47, 'div', 42)(48, 'button', 43),
      E('click', function () {
        y(t);
        let r = m(2);
        return v(r.cancelProfile());
      ...
      c(),
      l(50, 'button', 44),
      u(51, 'Save configuration'),
      c()()()());
  }
  if (e & 2) {
    let t = m(2);
    (f(5),
      N('', t.profile.id ? 'EDIT' : 'NEW', ' CONNECTION'),
      f(2),
      N('', t.profile.id ? 'Edit' : 'Add', ' configuration'),
      f(6),
      ...
      f(),
      _('ngIf', t.profile.databaseType === 'SYBASE_ASE'),
      f(),
      _('ngIf', t.profile.databaseType === 'ORACLE'),
      f(3),
...
function oC(e, n) {
  if ((e & 1 && (mt(0), I(1, rC, 2, 5, 'option', 62), gt()), e & 2)) {
    let t = n.$implicit;
...
function aC(e, n) {
  if ((e & 1 && (l(0, 'p', 65), u(1), c()), e & 2)) {
    let t = m(2);
    (f(), N(' ', t.schemaLists.export.error, ' '));
  }
}
function lC(e, n) {
  if ((e & 1 && (l(0, 'p'), u(1), c()), e & 2)) {
    let t = m().$implicit;
    (f(), N('Detected: ', t.detectedVersion, ''));
  }
}
function cC(e, n) {
  if (e & 1) {
  ...
  if (e & 2) {
    let t = m().$implicit;
    (f(), N(' ', t.schemaName ? 'Download schema ZIP' : 'Download legacy SQL', ' '));
  }
}
function uC(e, n) {
  if (e & 1) {
...
function fC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'section')(1, 'div', 17)(2, 'div')(3, 'p', 18),
      ...
      u(36, 'Refresh'),
      c()(),
      I(37, uC, 17, 14, 'div', 60)(38, dC, 2, 0, 'div', 61),
      c());
  }
  if (e & 2) {
    let t = m();
    (f(12),
      ...
      f(2),
      N(' ', t.schemaLists.export.loading ? 'Loading schemas\u2026' : 'Select schema', ' '),
      f(),
...
function pC(e, n) {
  if ((e & 1 && (l(0, 'option', 82), u(1), c()), e & 2)) {
    let t = n.$implicit;
    (_('ngValue', t.id)('hidden', t.databaseType !== 'SYBASE_ASE'), f(), N(' ', t.name, ' '));
  }
}
function hC(e, n) {
  if ((e & 1 && (l(0, 'option', 82), u(1), c()), e & 2)) {
    let t = n.$implicit;
    (_('ngValue', t.id)('hidden', t.databaseType !== 'ORACLE'), f(), N(' ', t.name, ' '));
  }
}
function mC(e, n) {
  if ((e & 1 && (l(0, 'option', 64), u(1), c()), e & 2)) {
...
function gC(e, n) {
  if ((e & 1 && (l(0, 'p', 65), u(1), c()), e & 2)) {
    let t = m(2);
    (f(), N(' ', t.schemaLists.migration.error, ' '));
  }
}
function _C(e, n) {
  if (e & 1) {
  ...
  if (e & 2) {
    let t = n.$implicit;
    (f(3), D(t.type), f(), N(' ', t.name, ''));
  }
}
function yC(e, n) {
  if ((e & 1 && (l(0, 'div', 83), I(1, _C, 5, 2, 'label', 21), c()), e & 2)) {
    let t = m(2);
...
function vC(e, n) {
  if (
    ...
    (f(5),
      ...
      f(4),
      N('', t.successWidth(), '% successful'),
      f(3),
      N('', t.failedWidth(), '% failed'),
      f(8),
...
function bC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'div', 94)(1, 'div')(2, 'strong'),
      ...
      c(),
      l(14, 'div', 69),
      I(15, CC, 2, 0, 'button', 97)(16, EC, 2, 0, 'button', 97)(17, DC, 2, 0, 'button', 97),
      l(18, 'label', 98),
      u(19, 'Upload log'),
      l(20, 'input', 99),
      E('change', function (r) {
...
function IC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'section')(1, 'div', 17)(2, 'div')(3, 'p', 18),
      ...
      c()(),
      I(53, vC, 36, 15, 'div', 80)(54, bC, 21, 13, 'div', 81)(55, wC, 2, 0, 'div', 61),
      c());
  }
  if (e & 2) {
    let t = m();
    (f(12),
      ...
      f(2),
      N(' ', t.schemaLists.migration.loading ? 'Loading schemas\u2026' : 'Select schema', ' '),
      f(),
...
function xC(e, n) {
  ...
  if (e & 2) {
    ...
    (f(3),
      ...
      f(3),
      N(' ', t.source.configurationName, ''),
      f(2),
      me('', t.source.databaseOrService, ' / ', t.source.schema, ''),
      f(2),
      N(' ', t.target.configurationName, ''),
      f(2),
...
function AC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'section')(1, 'div', 17)(2, 'div')(3, 'p', 18),
      ...
      c()()(),
      l(35, 'tbody'),
      I(36, xC, 24, 13, 'tr', 21)(37, SC, 3, 0, 'tr', 13),
      c()()(),
      ...
      c()()(),
      l(62, 'tbody'),
      I(63, MC, 20, 9, 'tr', 21)(64, TC, 3, 0, 'tr', 13),
      c()()()());
  }
  if (e & 2) {
    let t = m();
...
function jC(e, n) {
  if (
    (e & 1 &&
      ...
      c(),
      l(12, 'td'),
      I(13, VC, 2, 0, 'button', 115)(14, LC, 2, 0, 'span', 13),
      c()()),
    e & 2)
  ) {
    let t = n.$implicit;
...
function WC(e, n) {
  if (e & 1) {
    ...
    (mt(0),
      ...
      c()()(),
      l(77, 'tbody'),
      I(78, UC, 13, 8, 'tr', 21)(79, $C, 3, 0, 'tr', 13),
      c()()(),
      I(80, HC, 7, 5, 'div', 113),
      gt());
  }
  if (e & 2) {
    ...
    (f(6),
      ...
      f(),
      N(' ', t.objectChartWidth(!0), '% '),
      f(4),
      N('', t.objectMatchCount(!0), ' matched'),
      f(3),
      N('', t.objectMatchCount(!1), ' mismatched'),
      f(5),
      je(
        '--matched',
      ...
      f(4),
      N('', t.recordMatchCount(!0), ' matched'),
      f(3),
      N('', t.recordMatchCount(!1), ' mismatched/errors'),
      f(22),
...
function QC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'div', 28)(1, 'div', 119)(2, 'div', 30)(3, 'div')(4, 'p', 18),
      ...
      c()()(),
      l(28, 'tbody'),
      I(29, GC, 3, 1, 'tr', 21)(30, qC, 3, 0, 'tr', 13),
      c()(),
      ...
      c()()(),
      l(46, 'tbody'),
      I(47, zC, 3, 1, 'tr', 21)(48, ZC, 3, 0, 'tr', 13),
      c()(),
  ...
  if (e & 2) {
    let t = m(2);
    (f(7),
      N('', t.details.objectType, ' differences'),
      f(5),
...
function YC(e, n) {
  if (e & 1) {
    ...
    (l(0, 'section')(1, 'div', 17)(2, 'div')(3, 'p', 18),
      ...
      c()()(),
      l(57, 'tbody'),
      I(58, OC, 26, 15, 'tr', 21)(59, PC, 3, 0, 'tr', 13),
      c()()(),
      I(60, FC, 8, 2, 'div', 104)(61, kC, 11, 6, 'div', 104)(62, WC, 81, 19, 'ng-container', 13)(
        63,
        QC,
        56,
        17,
...
function XC(e, n) {
  ...
  if (e & 2) {
    ...
    (f(6),
      ...
      f(3),
      N(' ', t.columnForm.id ? 'Update' : 'Add', ' column '),
      f(12),
...
function eE(e, n) {
  ...
  if (e & 2) {
    ...
    (f(4),
      ...
      f(3),
      N(' ', t.logicalForm.id ? 'Update' : 'Add', ' table '),
      f(13),
...
function rE(e, n) {
  ...
  if (e & 2) {
    ...
    (f(4),
      ...
      f(3),
      N(' ', t.dbTableForm.id ? 'Update' : 'Add', ' mapping '),
      f(15),
...
function dE(e, n) {
  ...
  if (e & 2) {
    let t = n.$implicit,
      i = m(4);
    (f(2), D(i.mappingForTarget(t) || 'Drop source here'), f(), N('', t, ' '));
  }
}
function fE(e, n) {
  if (e & 1) {
...
function pE(e, n) {
  ...
  if (e & 2) {
    ...
    (f(4),
      ...
      f(3),
      N('', t.pairForm.id ? 'Update' : 'Add', ' pair'),
      f(13),
...
function _E(e, n) {
  ...
  if (e & 2) {
    ...
    (f(4),
      ...
      f(3),
      N('', t.batchForm.id ? 'Update' : 'Add', ' batch'),
      f(13),
...
function bE(e, n) {
  ...
  if (e & 2) {
    ...
    (f(4),
      ...
      f(2),
      N(' Download ', t.activeQualReport.zipFile, ' '),
      f(4),
...
function IE(e, n) {
  if (e & 1) {
    ...
    (mt(0),
      ...
      u(23, ' Execute '),
      c()(),
      I(24, EE, 12, 8, 'div', 140)(25, bE, 39, 8, 'div', 125),
...
function ME(e, n) {
  if (e & 1) {
    ...
    (l(0, 'section')(1, 'div', 17)(2, 'div')(3, 'p', 18),
      ...
      c()(),
      I(20, eE, 30, 7, 'ng-container', 13)(21, rE, 40, 11, 'ng-container', 13)(
        22,
        pE,
        39,
        13,
        'ng-container',
        13,
      )(23, _E, 27, 6, 'ng-container', 13)(24, IE, 43, 14, 'ng-container', 13)(
        25,
        SE,
        16,
        1,
...
function AE(e, n) {
  ...
  if (e & 2) {
    let t = m();
    (f(3),
      N('Database credentials: ', t.credentialProfileName(), ''),
      f(5),
      ...
      this.ɵcmp = Yc({
        ...
        template: function (i, r) {
          (i & 1 &&
            ...
            c()(),
            l(52, 'main'),
            I(53, Qv, 2, 1, 'p', 12)(54, iC, 31, 3, 'section', 13)(55, fC, 39, 13, 'section', 13)(
              56,
              IC,
              56,
              21,
              'section',
              13,
            )(57, AC, 65, 4, 'section', 13)(58, YC, 64, 15, 'section', 13)(
              59,
              ME,
              26,
              16,
              'section',
              13,
            )(60, TE, 9, 0, 'section', 14)(61, AE, 16, 5, 'div', 15),
            c()()()),
            i & 2 &&
              (f(17),
